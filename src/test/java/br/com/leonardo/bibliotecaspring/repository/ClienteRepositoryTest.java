...
public class ClienteRepositoryTest {
    ...
    public static void setup(@Autowired ClienteRepository clienteRepository){
        clienteRepository.saveAll(List.of(
                ClienteBuilder.umCliente().comId(1L).agora(),
                ClienteBuilder.umCliente().comId(2L).comNome("Joao").comCpf("23852633001").agora(),
                ClienteBuilder.umCliente().comId(3L).comNome("Maria").comCpf("41126661015").agora()
        ));
    }
